...
cord1 = newArray(450.0,430.0,150.0,150.0); //smallest center
cord2 = newArray(275, 255, 500, 500);
...
for (b = 0; b < 5; b++) {
	...
	for (n = 1; n <= nSlices(); n++) {
		setSlice(n);
		hname = fdir + "Hist_Sep_Band_B" + b + "_N" + (n-1) +".csv";
