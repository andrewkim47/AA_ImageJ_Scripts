...
cord1 = newArray(242, 223, 567, 567); //smallest center
cord2 = newArray(99, 85, 851, 851);

makebands(cord1,cord2,numbands);

nBins = 256;
sname = fdir + "Stat_Mn_Band.csv";
...
for (b = 0; b < 5; b++) {
	...
	for (n = 1; n <= nSlices(); n++) {
		setSlice(n);
		hname = fdir + "Hist_Mn_Band_B" + b + "_N" + (n-1) +".csv";
